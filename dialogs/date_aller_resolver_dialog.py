...
class DateAllerResolverDialog(CancelAndHelpDialog):
    """Resolve the date"""
    ...
    def __init__(
        ...
        super(DateAllerResolverDialog, self).__init__(
            dialog_id or DateAllerResolverDialog.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client

        date_time_prompt = DateTimePrompt(
            DateTimePrompt.__name__, DateAllerResolverDialog.datetime_prompt_validator
        )
    ...
    async def initial_step(
        ...
        prompt_msg = "On what date would you like to start the travel?"
        reprompt_msg = (
